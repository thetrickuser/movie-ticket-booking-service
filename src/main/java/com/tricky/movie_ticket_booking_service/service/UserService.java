...
public class UserService {
    ...
    public UserDTO addUser(UserDTO request) throws UserAlreadyExistsException {
    ...
    public UserDTO getUser(String username) throws UserNotFoudException {
        ...
        return userEntity.map(userMapper::toDTO).orElseThrow(() -> new UserNotFoudException("User not found"));
    }

    public UserDTO updateUser(int userId, UserDTO userDTO) throws UserNotFoudException {
    ...
    public void deleteUser(int id) throws UserNotFoudException {
        if (!userRepository.existsById(id)) throw new UserNotFoudException("User does not exist");
